<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="btlsach2.aspx.cs" Inherits="web11.btlsach2" %>
...
<html>
    ...
    <div class="truyen">
            <div class="anh">
                <img src="/img/ark4.jpg" alt="">
            </div>

        <div class="gioithieu">
            <h3 style="    text-transform: uppercase;">ARK thế giới sinh tồn</h3><br><br>
                <div class="thongtin">
